...
<div class="container">
    <div class="row justify-content-center mt-lg-5">
        <div class="col-md-8">        
            <div class="card card-default" style="margin-top: 50px; margin-bottom: 100px;">
                <div class="card-header text-center text-white h3" style=" background-color: #214a26;letter-spacing: 2px; padding: 20px 0px;">Login</div>
